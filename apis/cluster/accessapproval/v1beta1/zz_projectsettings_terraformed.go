...
func (tr *ProjectSettings) GetObservation() (map[string]any, error) {
...
func (tr *ProjectSettings) SetObservation(obs map[string]any) error {
...
func (tr *ProjectSettings) GetParameters() (map[string]any, error) {
...
func (tr *ProjectSettings) SetParameters(params map[string]any) error {
...
// GetInitParameters of this ProjectSettings
func (tr *ProjectSettings) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this ProjectSettings
func (tr *ProjectSettings) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
