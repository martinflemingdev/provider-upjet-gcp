...
type VPNTunnelInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/apis/cluster/compute/v1beta1.ExternalVPNGateway
	...
	// associated.
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/apis/cluster/compute/v1beta1.VPNGateway
	...
	// This field must reference a google_compute_ha_vpn_gateway resource.
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/apis/cluster/compute/v1beta1.HaVPNGateway
