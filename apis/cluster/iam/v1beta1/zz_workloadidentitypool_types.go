...
type AdditionalTrustBundlesInitParameters struct {
	...
	TrustAnchors []AdditionalTrustBundlesTrustAnchorsInitParameters `json:"trustAnchors,omitempty" tf:"trust_anchors,omitempty"`
...
type AdditionalTrustBundlesObservation struct {
	...
	// trust anchors here.
	// Structure is documented below.
	TrustAnchors []AdditionalTrustBundlesTrustAnchorsObservation `json:"trustAnchors,omitempty" tf:"trust_anchors,omitempty"`
...
type AdditionalTrustBundlesParameters struct {
	...
	TrustAnchors []AdditionalTrustBundlesTrustAnchorsParameters `json:"trustAnchors" tf:"trust_anchors,omitempty"`
...
type AdditionalTrustBundlesTrustAnchorsInitParameters struct {
...
type AdditionalTrustBundlesTrustAnchorsObservation struct {
...
type AdditionalTrustBundlesTrustAnchorsParameters struct {
