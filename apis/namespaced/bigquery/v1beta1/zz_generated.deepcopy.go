...
func (in *SensitiveParamsInitParameters) DeepCopyInto(out *SensitiveParamsInitParameters) {
	*out = *in
	...
	if in.SecretAccessKeyWo != nil {
		in, out := &in.SecretAccessKeyWo, &out.SecretAccessKeyWo
		*out = new(string)
		**out = **in
	}
	if in.SecretAccessKeyWoVersion != nil {
		in, out := &in.SecretAccessKeyWoVersion, &out.SecretAccessKeyWoVersion
		*out = new(float64)
		**out = **in
	}
}
