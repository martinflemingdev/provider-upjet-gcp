...
func (mg *Connection) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if mg.Spec.ForProvider.Spark != nil {
		if mg.Spec.ForProvider.Spark.SparkHistoryServerConfig != nil {
			{
				m, l, err = apisresolver.GetManagedResource("dataproc.gcp.m.upbound.io", "v1beta1", "Cluster", "ClusterList")
				if err != nil {
					return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
				}
				rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
...
func (mg *ReservationAssignment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("bigquery.gcp.m.upbound.io", "v1beta1", "Reservation", "ReservationList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *Routine) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if mg.Spec.ForProvider.RemoteFunctionOptions != nil {
		{
			m, l, err = apisresolver.GetManagedResource("bigquery.gcp.m.upbound.io", "v1beta1", "Connection", "ConnectionList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			}
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
