...
type AllUpdatesRuleInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/v2/apis/namespaced/monitoring/v1beta1.NotificationChannel
	...
	MonitoringNotificationChannelsRefs []v1.NamespacedReference `json:"monitoringNotificationChannelsRefs,omitempty" tf:"-"`

	// Selector for a list of NotificationChannel in monitoring to populate monitoringNotificationChannels.
	// +kubebuilder:validation:Optional
	MonitoringNotificationChannelsSelector *v1.NamespacedSelector `json:"monitoringNotificationChannelsSelector,omitempty" tf:"-"`
