...
func (in *AllowlistedCertificatesInitParameters) DeepCopy() *AllowlistedCertificatesInitParameters {
	...
	out := new(AllowlistedCertificatesInitParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AllowlistedCertificatesObservation) DeepCopy() *AllowlistedCertificatesObservation {
	...
	out := new(AllowlistedCertificatesObservation)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AllowlistedCertificatesParameters) DeepCopy() *AllowlistedCertificatesParameters {
	...
	out := new(AllowlistedCertificatesParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IntermediateCasInitParameters) DeepCopyInto(out *IntermediateCasInitParameters) {
	*out = *in
	if in.PemCertificateSecretRef != nil {
		in, out := &in.PemCertificateSecretRef, &out.PemCertificateSecretRef
...
func (in *TrustConfigInitParameters) DeepCopyInto(out *TrustConfigInitParameters) {
	*out = *in
	if in.AllowlistedCertificates != nil {
		in, out := &in.AllowlistedCertificates, &out.AllowlistedCertificates
		*out = make([]AllowlistedCertificatesInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.TrustStores != nil {
		...
		*out = make([]TrustStoresInitParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *TrustConfigObservation) DeepCopyInto(out *TrustConfigObservation) {
	*out = *in
	if in.AllowlistedCertificates != nil {
		in, out := &in.AllowlistedCertificates, &out.AllowlistedCertificates
		*out = make([]AllowlistedCertificatesObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.TrustStores != nil {
		in, out := &in.TrustStores, &out.TrustStores
		*out = make([]TrustStoresObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *TrustConfigParameters) DeepCopyInto(out *TrustConfigParameters) {
	*out = *in
	if in.AllowlistedCertificates != nil {
		in, out := &in.AllowlistedCertificates, &out.AllowlistedCertificates
		*out = make([]AllowlistedCertificatesParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.TrustStores != nil {
		in, out := &in.TrustStores, &out.TrustStores
		*out = make([]TrustStoresParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *TrustStoresInitParameters) DeepCopy() *TrustStoresInitParameters {
	...
	out := new(TrustStoresInitParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TrustStoresObservation) DeepCopy() *TrustStoresObservation {
	...
	out := new(TrustStoresObservation)
	in.DeepCopyInto(out)
	return out
}
