...
type FunctionIAMMemberInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/v2/apis/namespaced/cloudfunctions2/v1beta1.Function
	CloudFunction *string `json:"cloudFunction,omitempty" tf:"cloud_function,omitempty"`

	// Reference to a Function in cloudfunctions2 to populate cloudFunction.
	// +kubebuilder:validation:Optional
	CloudFunctionRef *v1.NamespacedReference `json:"cloudFunctionRef,omitempty" tf:"-"`

	// Selector for a Function in cloudfunctions2 to populate cloudFunction.
	// +kubebuilder:validation:Optional
