...
func (mg *Function) ResolveReferences( // ResolveReferences of this Function.
	...
	if mg.Spec.ForProvider.BuildConfig != nil {
		if mg.Spec.ForProvider.BuildConfig.Source != nil {
			if mg.Spec.ForProvider.BuildConfig.Source.StorageSource != nil {
				{
					m, l, err = apisresolver.GetManagedResource("storage.gcp.m.upbound.io", "v1beta1", "BucketObject", "BucketObjectList")
					if err != nil {
						return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
					}
					rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
	...
	if mg.Spec.ForProvider.BuildConfig != nil {
		{
			m, l, err = apisresolver.GetManagedResource("cloudbuild.gcp.m.upbound.io", "v1beta1", "WorkerPool", "WorkerPoolList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			}
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
