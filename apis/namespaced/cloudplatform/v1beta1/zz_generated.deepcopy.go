...
func (in *FolderObservation) DeepCopyInto(out *FolderObservation) {
	*out = *in
	if in.ConfiguredCapabilities != nil {
		in, out := &in.ConfiguredCapabilities, &out.ConfiguredCapabilities
		*out = make([]*string, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
	...
	if in.ManagementProject != nil {
		in, out := &in.ManagementProject, &out.ManagementProject
		*out = new(string)
		**out = **in
	}
	if in.Name != nil {
