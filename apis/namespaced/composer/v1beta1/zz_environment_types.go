...
type NodeConfigInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ComposerNetworkAttachmentRef *v1.NamespacedReference `json:"composerNetworkAttachmentRef,omitempty" tf:"-"`

	// Selector for a NetworkAttachment in compute to populate composerNetworkAttachment.
	// +kubebuilder:validation:Optional
	ComposerNetworkAttachmentSelector *v1.NamespacedSelector `json:"composerNetworkAttachmentSelector,omitempty" tf:"-"`
