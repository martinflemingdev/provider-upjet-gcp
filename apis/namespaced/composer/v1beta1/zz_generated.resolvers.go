...
// ResolveReferences of this UserWorkloadsConfigMap.
func (mg *UserWorkloadsConfigMap) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPINamespacedResolver(c, mg)
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("composer.gcp.m.upbound.io", "v1beta1", "Environment", "EnvironmentList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
// ResolveReferences of this UserWorkloadsSecret.
func (mg *UserWorkloadsSecret) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPINamespacedResolver(c, mg)
