...
type BackendInitParameters struct {
	...
	// partial URL.
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/v3/apis/namespaced/compute/v1beta1.InstanceGroupManager
	// +crossplane:generate:reference:extractor=github.com/upbound/provider-gcp/v3/config/namespaced/compute.InstanceGroupExtractor()
...
type BackendServiceInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/v3/apis/namespaced/compute/v1beta1.HealthCheck
	// +crossplane:generate:reference:extractor=github.com/upbound/provider-gcp/v3/config/namespaced/common.SelfLinkExtractor()
	// +listType=set
...
type IapInitParameters struct {
	...
	Oauth2ClientIDWo *string `json:"oauth2ClientIdWo,omitempty" tf:"oauth2_client_id_wo,omitempty"`
	...
	// OAuth2 Client Secret for IAP
	// Note: This property is write-only and will not be read from the API.
	Oauth2ClientSecretWo *string `json:"oauth2ClientSecretWo,omitempty" tf:"oauth2_client_secret_wo,omitempty"`
