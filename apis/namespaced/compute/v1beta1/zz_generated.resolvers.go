...
import (
	...
	compute "github.com/upbound/provider-gcp/v2/config/namespaced/compute"
...
func (mg *AttachedDisk) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "Disk", "DiskList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *Autoscaler) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "InstanceGroupManager", "InstanceGroupManagerList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *BackendBucket) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "SecurityPolicy", "SecurityPolicyList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *BackendBucketSignedURLKey) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "BackendBucket", "BackendBucketList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *DiskResourcePolicyAttachment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.DiskRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "ResourcePolicy", "ResourcePolicyList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *FirewallPolicyAssociation) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "FirewallPolicy", "FirewallPolicyList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *FirewallPolicyRule) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if mg.Spec.ForProvider.Match != nil {
		{
			m, l, err = apisresolver.GetManagedResource("networksecurity.gcp.m.upbound.io", "v1beta1", "AddressGroup", "AddressGroupList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			}
			mrsp, err = r.ResolveMultiple(ctx, reference.MultiNamespacedResolutionRequest{
...
func (mg *ForwardingRule) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "RegionBackendService", "RegionBackendServiceList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	mg.Spec.ForProvider.SubnetworkRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "RegionTargetHTTPProxy", "RegionTargetHTTPProxyList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *GlobalForwardingRule) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "GlobalAddress", "GlobalAddressList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	mg.Spec.ForProvider.SubnetworkRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "TargetSSLProxy", "TargetSSLProxyList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *GlobalNetworkEndpoint) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "GlobalNetworkEndpointGroup", "GlobalNetworkEndpointGroupList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *ImageIAMMember) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "Image", "ImageList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *InstanceFromTemplate) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "InstanceTemplate", "InstanceTemplateList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
		rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
...
func (mg *InstanceGroupManager) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if mg.Spec.ForProvider.ResourcePolicies != nil {
		{
			m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "ResourcePolicy", "ResourcePolicyList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			...
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
				CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.ResourcePolicies.WorkloadPolicy),
				Extract:      resource.ExtractParamPath("self_link", true),
				Namespace:    mg.GetNamespace(),
				Reference:    mg.Spec.ForProvider.ResourcePolicies.WorkloadPolicyRef,
				Selector:     mg.Spec.ForProvider.ResourcePolicies.WorkloadPolicySelector,
				To:           reference.To{List: l, Managed: m},
			})
		}
		if err != nil {
			return errors.Wrap(err, "mg.Spec.ForProvider.ResourcePolicies.WorkloadPolicy")
		}
		mg.Spec.ForProvider.ResourcePolicies.WorkloadPolicy = reference.ToPtrValue(rsp.ResolvedValue)
		mg.Spec.ForProvider.ResourcePolicies.WorkloadPolicyRef = rsp.ResolvedReference

	}
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "TargetPool", "TargetPoolList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
		mrsp, err = r.ResolveMultiple(ctx, reference.MultiNamespacedResolutionRequest{
	...
	if mg.Spec.InitProvider.ResourcePolicies != nil {
		{
			m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "ResourcePolicy", "ResourcePolicyList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			...
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
				CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.ResourcePolicies.WorkloadPolicy),
				Extract:      resource.ExtractParamPath("self_link", true),
				Namespace:    mg.GetNamespace(),
				Reference:    mg.Spec.InitProvider.ResourcePolicies.WorkloadPolicyRef,
				Selector:     mg.Spec.InitProvider.ResourcePolicies.WorkloadPolicySelector,
				To:           reference.To{List: l, Managed: m},
			})
		}
		if err != nil {
			return errors.Wrap(err, "mg.Spec.InitProvider.ResourcePolicies.WorkloadPolicy")
		}
		mg.Spec.InitProvider.ResourcePolicies.WorkloadPolicy = reference.ToPtrValue(rsp.ResolvedValue)
		mg.Spec.InitProvider.ResourcePolicies.WorkloadPolicyRef = rsp.ResolvedReference
...
func (mg *InterconnectAttachment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "Router", "RouterList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *NetworkAttachment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		...
		mrsp, err = r.ResolveMultiple(ctx, reference.MultiNamespacedResolutionRequest{
			CurrentValues: reference.FromPtrValues(mg.Spec.ForProvider.ProducerAcceptLists),
			Extract:       resource.ExtractParamPath("project_id", false),
			Namespace:     mg.GetNamespace(),
			References:    mg.Spec.ForProvider.ProducerAcceptListsRefs,
			Selector:      mg.Spec.ForProvider.ProducerAcceptListsSelector,
			To:            reference.To{List: l, Managed: m},
		})
	}
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.ProducerAcceptLists")
	}
	mg.Spec.ForProvider.ProducerAcceptLists = reference.ToPtrValues(mrsp.ResolvedValues)
	mg.Spec.ForProvider.ProducerAcceptListsRefs = mrsp.ResolvedReferences
	{
		m, l, err = apisresolver.GetManagedResource("cloudplatform.gcp.m.upbound.io", "v1beta1", "Project", "ProjectList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		...
		mrsp, err = r.ResolveMultiple(ctx, reference.MultiNamespacedResolutionRequest{
			CurrentValues: reference.FromPtrValues(mg.Spec.ForProvider.ProducerRejectLists),
			Extract:       resource.ExtractParamPath("project_id", false),
			Namespace:     mg.GetNamespace(),
			References:    mg.Spec.ForProvider.ProducerRejectListsRefs,
			Selector:      mg.Spec.ForProvider.ProducerRejectListsSelector,
			To:            reference.To{List: l, Managed: m},
		})
	}
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.ProducerRejectLists")
	}
	mg.Spec.ForProvider.ProducerRejectLists = reference.ToPtrValues(mrsp.ResolvedValues)
	mg.Spec.ForProvider.ProducerRejectListsRefs = mrsp.ResolvedReferences
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "Subnetwork", "SubnetworkList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		...
		mrsp, err = r.ResolveMultiple(ctx, reference.MultiNamespacedResolutionRequest{
			CurrentValues: reference.FromPtrValues(mg.Spec.ForProvider.Subnetworks),
			Extract:       common.SelfLinkExtractor(),
			Namespace:     mg.GetNamespace(),
			References:    mg.Spec.ForProvider.SubnetworksRefs,
			Selector:      mg.Spec.ForProvider.SubnetworksSelector,
			To:            reference.To{List: l, Managed: m},
		})
	}
	if err != nil {
		return errors.Wrap(err, "mg.Spec.ForProvider.Subnetworks")
	}
	mg.Spec.ForProvider.Subnetworks = reference.ToPtrValues(mrsp.ResolvedValues)
	mg.Spec.ForProvider.SubnetworksRefs = mrsp.ResolvedReferences
	{
		m, l, err = apisresolver.GetManagedResource("cloudplatform.gcp.m.upbound.io", "v1beta1", "Project", "ProjectList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		...
		mrsp, err = r.ResolveMultiple(ctx, reference.MultiNamespacedResolutionRequest{
			CurrentValues: reference.FromPtrValues(mg.Spec.InitProvider.ProducerAcceptLists),
			Extract:       resource.ExtractParamPath("project_id", false),
			Namespace:     mg.GetNamespace(),
			References:    mg.Spec.InitProvider.ProducerAcceptListsRefs,
			Selector:      mg.Spec.InitProvider.ProducerAcceptListsSelector,
			To:            reference.To{List: l, Managed: m},
		})
	}
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.ProducerAcceptLists")
	}
	mg.Spec.InitProvider.ProducerAcceptLists = reference.ToPtrValues(mrsp.ResolvedValues)
	mg.Spec.InitProvider.ProducerAcceptListsRefs = mrsp.ResolvedReferences
	{
		m, l, err = apisresolver.GetManagedResource("cloudplatform.gcp.m.upbound.io", "v1beta1", "Project", "ProjectList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		...
		mrsp, err = r.ResolveMultiple(ctx, reference.MultiNamespacedResolutionRequest{
			CurrentValues: reference.FromPtrValues(mg.Spec.InitProvider.ProducerRejectLists),
			Extract:       resource.ExtractParamPath("project_id", false),
			Namespace:     mg.GetNamespace(),
			References:    mg.Spec.InitProvider.ProducerRejectListsRefs,
			Selector:      mg.Spec.InitProvider.ProducerRejectListsSelector,
			To:            reference.To{List: l, Managed: m},
		})
	}
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.ProducerRejectLists")
	}
	mg.Spec.InitProvider.ProducerRejectLists = reference.ToPtrValues(mrsp.ResolvedValues)
	mg.Spec.InitProvider.ProducerRejectListsRefs = mrsp.ResolvedReferences
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "Subnetwork", "SubnetworkList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		...
		mrsp, err = r.ResolveMultiple(ctx, reference.MultiNamespacedResolutionRequest{
			CurrentValues: reference.FromPtrValues(mg.Spec.InitProvider.Subnetworks),
			Extract:       common.SelfLinkExtractor(),
			Namespace:     mg.GetNamespace(),
			References:    mg.Spec.InitProvider.SubnetworksRefs,
			Selector:      mg.Spec.InitProvider.SubnetworksSelector,
			To:            reference.To{List: l, Managed: m},
		})
	}
	if err != nil {
		return errors.Wrap(err, "mg.Spec.InitProvider.Subnetworks")
	}
	mg.Spec.InitProvider.Subnetworks = reference.ToPtrValues(mrsp.ResolvedValues)
	mg.Spec.InitProvider.SubnetworksRefs = mrsp.ResolvedReferences
...
func (mg *NetworkEndpoint) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.InstanceRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "NetworkEndpointGroup", "NetworkEndpointGroupList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *NetworkFirewallPolicyAssociation) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.AttachmentTargetRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "NetworkFirewallPolicy", "NetworkFirewallPolicyList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *NetworkPeeringRoutesConfig) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.NetworkRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "NetworkPeering", "NetworkPeeringList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *NodeGroup) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "NodeTemplate", "NodeTemplateList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *PacketMirroring) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if mg.Spec.ForProvider.MirroredResources != nil {
		for i4 := 0; i4 < len(mg.Spec.ForProvider.MirroredResources.Subnetworks); i4++ {
			{
				m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "Subnetwork", "SubnetworkList")
				if err != nil {
					return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
				...
				rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
					CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.MirroredResources.Subnetworks[i4].URL),
					Extract:      resource.ExtractResourceID(),
					Namespace:    mg.GetNamespace(),
					Reference:    mg.Spec.ForProvider.MirroredResources.Subnetworks[i4].URLRef,
					Selector:     mg.Spec.ForProvider.MirroredResources.Subnetworks[i4].URLSelector,
					To:           reference.To{List: l, Managed: m},
				})
			}
			if err != nil {
				return errors.Wrap(err, "mg.Spec.ForProvider.MirroredResources.Subnetworks[i4].URL")
			}
			mg.Spec.ForProvider.MirroredResources.Subnetworks[i4].URL = reference.ToPtrValue(rsp.ResolvedValue)
			mg.Spec.ForProvider.MirroredResources.Subnetworks[i4].URLRef = rsp.ResolvedReference
	...
	if mg.Spec.InitProvider.MirroredResources != nil {
		for i4 := 0; i4 < len(mg.Spec.InitProvider.MirroredResources.Subnetworks); i4++ {
			{
				m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "Subnetwork", "SubnetworkList")
				if err != nil {
					return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
				...
				rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
					CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.MirroredResources.Subnetworks[i4].URL),
					Extract:      resource.ExtractResourceID(),
					Namespace:    mg.GetNamespace(),
					Reference:    mg.Spec.InitProvider.MirroredResources.Subnetworks[i4].URLRef,
					Selector:     mg.Spec.InitProvider.MirroredResources.Subnetworks[i4].URLSelector,
					To:           reference.To{List: l, Managed: m},
				})
			}
			if err != nil {
				return errors.Wrap(err, "mg.Spec.InitProvider.MirroredResources.Subnetworks[i4].URL")
			}
			mg.Spec.InitProvider.MirroredResources.Subnetworks[i4].URL = reference.ToPtrValue(rsp.ResolvedValue)
			mg.Spec.InitProvider.MirroredResources.Subnetworks[i4].URLRef = rsp.ResolvedReference
...
func (mg *RegionAutoscaler) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "RegionInstanceGroupManager", "RegionInstanceGroupManagerList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *RegionBackendService) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if mg.Spec.ForProvider.HaPolicy != nil {
		if mg.Spec.ForProvider.HaPolicy.Leader != nil {
			{
				m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "NetworkEndpointGroup", "NetworkEndpointGroupList")
				if err != nil {
					return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
				...
				rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
					CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.HaPolicy.Leader.BackendGroup),
					Extract:      resource.ExtractParamPath("self_link", true),
					Namespace:    mg.GetNamespace(),
					Reference:    mg.Spec.ForProvider.HaPolicy.Leader.BackendGroupRef,
					Selector:     mg.Spec.ForProvider.HaPolicy.Leader.BackendGroupSelector,
					To:           reference.To{List: l, Managed: m},
				})
			}
			if err != nil {
				return errors.Wrap(err, "mg.Spec.ForProvider.HaPolicy.Leader.BackendGroup")
			}
			mg.Spec.ForProvider.HaPolicy.Leader.BackendGroup = reference.ToPtrValue(rsp.ResolvedValue)
			mg.Spec.ForProvider.HaPolicy.Leader.BackendGroupRef = rsp.ResolvedReference

		}
	}
	if mg.Spec.ForProvider.HaPolicy != nil {
		if mg.Spec.ForProvider.HaPolicy.Leader != nil {
			if mg.Spec.ForProvider.HaPolicy.Leader.NetworkEndpoint != nil {
				{
					m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "Instance", "InstanceList")
					if err != nil {
						return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
					...
					rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
						CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.HaPolicy.Leader.NetworkEndpoint.Instance),
						Extract:      reference.ExternalName(),
						Namespace:    mg.GetNamespace(),
						Reference:    mg.Spec.ForProvider.HaPolicy.Leader.NetworkEndpoint.InstanceRef,
						Selector:     mg.Spec.ForProvider.HaPolicy.Leader.NetworkEndpoint.InstanceSelector,
						To:           reference.To{List: l, Managed: m},
					})
				}
				if err != nil {
					return errors.Wrap(err, "mg.Spec.ForProvider.HaPolicy.Leader.NetworkEndpoint.Instance")
				}
				mg.Spec.ForProvider.HaPolicy.Leader.NetworkEndpoint.Instance = reference.ToPtrValue(rsp.ResolvedValue)
				mg.Spec.ForProvider.HaPolicy.Leader.NetworkEndpoint.InstanceRef = rsp.ResolvedReference

			}
		}
	}
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "RegionHealthCheck", "RegionHealthCheckList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
		mrsp, err = r.ResolveMultiple(ctx, reference.MultiNamespacedResolutionRequest{
	...
	if mg.Spec.InitProvider.HaPolicy != nil {
		if mg.Spec.InitProvider.HaPolicy.Leader != nil {
			{
				m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "NetworkEndpointGroup", "NetworkEndpointGroupList")
				if err != nil {
					return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
				...
				rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
					CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.HaPolicy.Leader.BackendGroup),
					Extract:      resource.ExtractParamPath("self_link", true),
					Namespace:    mg.GetNamespace(),
					Reference:    mg.Spec.InitProvider.HaPolicy.Leader.BackendGroupRef,
					Selector:     mg.Spec.InitProvider.HaPolicy.Leader.BackendGroupSelector,
					To:           reference.To{List: l, Managed: m},
				})
			}
			if err != nil {
				return errors.Wrap(err, "mg.Spec.InitProvider.HaPolicy.Leader.BackendGroup")
			}
			mg.Spec.InitProvider.HaPolicy.Leader.BackendGroup = reference.ToPtrValue(rsp.ResolvedValue)
			mg.Spec.InitProvider.HaPolicy.Leader.BackendGroupRef = rsp.ResolvedReference

		}
	}
	if mg.Spec.InitProvider.HaPolicy != nil {
		if mg.Spec.InitProvider.HaPolicy.Leader != nil {
			if mg.Spec.InitProvider.HaPolicy.Leader.NetworkEndpoint != nil {
				{
					m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "Instance", "InstanceList")
					if err != nil {
						return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
					...
					rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
						CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.HaPolicy.Leader.NetworkEndpoint.Instance),
						Extract:      reference.ExternalName(),
						Namespace:    mg.GetNamespace(),
						Reference:    mg.Spec.InitProvider.HaPolicy.Leader.NetworkEndpoint.InstanceRef,
						Selector:     mg.Spec.InitProvider.HaPolicy.Leader.NetworkEndpoint.InstanceSelector,
						To:           reference.To{List: l, Managed: m},
					})
				}
				if err != nil {
					return errors.Wrap(err, "mg.Spec.InitProvider.HaPolicy.Leader.NetworkEndpoint.Instance")
				}
				mg.Spec.InitProvider.HaPolicy.Leader.NetworkEndpoint.Instance = reference.ToPtrValue(rsp.ResolvedValue)
				mg.Spec.InitProvider.HaPolicy.Leader.NetworkEndpoint.InstanceRef = rsp.ResolvedReference
...
func (mg *RegionDisk) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if mg.Spec.ForProvider.AsyncPrimaryDisk != nil {
		{
			m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "RegionDisk", "RegionDiskList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			}
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
	...
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "Snapshot", "SnapshotList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
		rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
...
func (mg *RegionNetworkEndpoint) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.InstanceRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "RegionNetworkEndpointGroup", "RegionNetworkEndpointGroupList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *RegionNetworkEndpointGroup) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if mg.Spec.ForProvider.CloudFunction != nil {
		{
			m, l, err = apisresolver.GetManagedResource("cloudfunctions.gcp.m.upbound.io", "v1beta1", "Function", "FunctionList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			}
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
	...
	mg.Spec.ForProvider.NetworkRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "ServiceAttachment", "ServiceAttachmentList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *RegionNetworkFirewallPolicyAssociation) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.AttachmentTargetRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "RegionNetworkFirewallPolicy", "RegionNetworkFirewallPolicyList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *RegionTargetHTTPProxy) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "RegionURLMap", "RegionURLMapList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *RegionTargetHTTPSProxy) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "RegionSSLCertificate", "RegionSSLCertificateList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *RegionURLMap) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.PathMatcher); i3++ {
		if mg.Spec.ForProvider.PathMatcher[i3].DefaultRouteAction != nil {
			if mg.Spec.ForProvider.PathMatcher[i3].DefaultRouteAction.RequestMirrorPolicy != nil {
				{
					m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "RegionBackendService", "RegionBackendServiceList")
					if err != nil {
						return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
					...
					rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
						CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.PathMatcher[i3].DefaultRouteAction.RequestMirrorPolicy.BackendService),
						Extract:      resource.ExtractResourceID(),
						Namespace:    mg.GetNamespace(),
						Reference:    mg.Spec.ForProvider.PathMatcher[i3].DefaultRouteAction.RequestMirrorPolicy.BackendServiceRef,
						Selector:     mg.Spec.ForProvider.PathMatcher[i3].DefaultRouteAction.RequestMirrorPolicy.BackendServiceSelector,
						To:           reference.To{List: l, Managed: m},
					})
				}
				if err != nil {
					return errors.Wrap(err, "mg.Spec.ForProvider.PathMatcher[i3].DefaultRouteAction.RequestMirrorPolicy.BackendService")
				}
				mg.Spec.ForProvider.PathMatcher[i3].DefaultRouteAction.RequestMirrorPolicy.BackendService = reference.ToPtrValue(rsp.ResolvedValue)
				mg.Spec.ForProvider.PathMatcher[i3].DefaultRouteAction.RequestMirrorPolicy.BackendServiceRef = rsp.ResolvedReference
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.PathMatcher); i3++ {
		if mg.Spec.ForProvider.PathMatcher[i3].DefaultRouteAction != nil {
			for i5 := 0; i5 < len(mg.Spec.ForProvider.PathMatcher[i3].DefaultRouteAction.WeightedBackendServices); i5++ {
				{
					m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "RegionBackendService", "RegionBackendServiceList")
					if err != nil {
						return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
					...
					rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
						CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.PathMatcher[i3].DefaultRouteAction.WeightedBackendServices[i5].BackendService),
						Extract:      resource.ExtractResourceID(),
						Namespace:    mg.GetNamespace(),
						Reference:    mg.Spec.ForProvider.PathMatcher[i3].DefaultRouteAction.WeightedBackendServices[i5].BackendServiceRef,
						Selector:     mg.Spec.ForProvider.PathMatcher[i3].DefaultRouteAction.WeightedBackendServices[i5].BackendServiceSelector,
						To:           reference.To{List: l, Managed: m},
					})
				}
				if err != nil {
					return errors.Wrap(err, "mg.Spec.ForProvider.PathMatcher[i3].DefaultRouteAction.WeightedBackendServices[i5].BackendService")
				}
				mg.Spec.ForProvider.PathMatcher[i3].DefaultRouteAction.WeightedBackendServices[i5].BackendService = reference.ToPtrValue(rsp.ResolvedValue)
				mg.Spec.ForProvider.PathMatcher[i3].DefaultRouteAction.WeightedBackendServices[i5].BackendServiceRef = rsp.ResolvedReference
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.PathMatcher); i3++ {
		if mg.Spec.InitProvider.PathMatcher[i3].DefaultRouteAction != nil {
			if mg.Spec.InitProvider.PathMatcher[i3].DefaultRouteAction.RequestMirrorPolicy != nil {
				{
					m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "RegionBackendService", "RegionBackendServiceList")
					if err != nil {
						return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
					...
					rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
						CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.PathMatcher[i3].DefaultRouteAction.RequestMirrorPolicy.BackendService),
						Extract:      resource.ExtractResourceID(),
						Namespace:    mg.GetNamespace(),
						Reference:    mg.Spec.InitProvider.PathMatcher[i3].DefaultRouteAction.RequestMirrorPolicy.BackendServiceRef,
						Selector:     mg.Spec.InitProvider.PathMatcher[i3].DefaultRouteAction.RequestMirrorPolicy.BackendServiceSelector,
						To:           reference.To{List: l, Managed: m},
					})
				}
				if err != nil {
					return errors.Wrap(err, "mg.Spec.InitProvider.PathMatcher[i3].DefaultRouteAction.RequestMirrorPolicy.BackendService")
				}
				mg.Spec.InitProvider.PathMatcher[i3].DefaultRouteAction.RequestMirrorPolicy.BackendService = reference.ToPtrValue(rsp.ResolvedValue)
				mg.Spec.InitProvider.PathMatcher[i3].DefaultRouteAction.RequestMirrorPolicy.BackendServiceRef = rsp.ResolvedReference
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.PathMatcher); i3++ {
		if mg.Spec.InitProvider.PathMatcher[i3].DefaultRouteAction != nil {
			for i5 := 0; i5 < len(mg.Spec.InitProvider.PathMatcher[i3].DefaultRouteAction.WeightedBackendServices); i5++ {
				{
					m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "RegionBackendService", "RegionBackendServiceList")
					if err != nil {
						return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
					...
					rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
						CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.PathMatcher[i3].DefaultRouteAction.WeightedBackendServices[i5].BackendService),
						Extract:      resource.ExtractResourceID(),
						Namespace:    mg.GetNamespace(),
						Reference:    mg.Spec.InitProvider.PathMatcher[i3].DefaultRouteAction.WeightedBackendServices[i5].BackendServiceRef,
						Selector:     mg.Spec.InitProvider.PathMatcher[i3].DefaultRouteAction.WeightedBackendServices[i5].BackendServiceSelector,
						To:           reference.To{List: l, Managed: m},
					})
				}
				if err != nil {
					return errors.Wrap(err, "mg.Spec.InitProvider.PathMatcher[i3].DefaultRouteAction.WeightedBackendServices[i5].BackendService")
				}
				mg.Spec.InitProvider.PathMatcher[i3].DefaultRouteAction.WeightedBackendServices[i5].BackendService = reference.ToPtrValue(rsp.ResolvedValue)
				mg.Spec.InitProvider.PathMatcher[i3].DefaultRouteAction.WeightedBackendServices[i5].BackendServiceRef = rsp.ResolvedReference
...
func (mg *RouterPeer) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "RouterInterface", "RouterInterfaceList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *TargetGRPCProxy) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "URLMap", "URLMapList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *TargetHTTPSProxy) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "SSLCertificate", "SSLCertificateList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *TargetPool) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "HTTPHealthCheck", "HTTPHealthCheckList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *URLMap) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if mg.Spec.ForProvider.DefaultCustomErrorResponsePolicy != nil {
		{
			m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "BackendBucket", "BackendBucketList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			...
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
				CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.DefaultCustomErrorResponsePolicy.ErrorService),
				Extract:      resource.ExtractResourceID(),
				Namespace:    mg.GetNamespace(),
				Reference:    mg.Spec.ForProvider.DefaultCustomErrorResponsePolicy.ErrorServiceRef,
				Selector:     mg.Spec.ForProvider.DefaultCustomErrorResponsePolicy.ErrorServiceSelector,
				To:           reference.To{List: l, Managed: m},
			})
		}
		if err != nil {
			return errors.Wrap(err, "mg.Spec.ForProvider.DefaultCustomErrorResponsePolicy.ErrorService")
		}
		mg.Spec.ForProvider.DefaultCustomErrorResponsePolicy.ErrorService = reference.ToPtrValue(rsp.ResolvedValue)
		mg.Spec.ForProvider.DefaultCustomErrorResponsePolicy.ErrorServiceRef = rsp.ResolvedReference
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.PathMatcher); i3++ {
		if mg.Spec.ForProvider.PathMatcher[i3].DefaultCustomErrorResponsePolicy != nil {
			{
				m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "BackendBucket", "BackendBucketList")
				if err != nil {
					return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
				...
				rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
					CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.PathMatcher[i3].DefaultCustomErrorResponsePolicy.ErrorService),
					Extract:      resource.ExtractResourceID(),
					Namespace:    mg.GetNamespace(),
					Reference:    mg.Spec.ForProvider.PathMatcher[i3].DefaultCustomErrorResponsePolicy.ErrorServiceRef,
					Selector:     mg.Spec.ForProvider.PathMatcher[i3].DefaultCustomErrorResponsePolicy.ErrorServiceSelector,
					To:           reference.To{List: l, Managed: m},
				})
			}
			if err != nil {
				return errors.Wrap(err, "mg.Spec.ForProvider.PathMatcher[i3].DefaultCustomErrorResponsePolicy.ErrorService")
			}
			mg.Spec.ForProvider.PathMatcher[i3].DefaultCustomErrorResponsePolicy.ErrorService = reference.ToPtrValue(rsp.ResolvedValue)
			mg.Spec.ForProvider.PathMatcher[i3].DefaultCustomErrorResponsePolicy.ErrorServiceRef = rsp.ResolvedReference
	...
	for i3 := 0; i3 < len(mg.Spec.ForProvider.PathMatcher); i3++ {
		for i4 := 0; i4 < len(mg.Spec.ForProvider.PathMatcher[i3].PathRule); i4++ {
			if mg.Spec.ForProvider.PathMatcher[i3].PathRule[i4].CustomErrorResponsePolicy != nil {
				{
					m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "BackendBucket", "BackendBucketList")
					if err != nil {
						return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
					...
					rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
						CurrentValue: reference.FromPtrValue(mg.Spec.ForProvider.PathMatcher[i3].PathRule[i4].CustomErrorResponsePolicy.ErrorService),
						Extract:      resource.ExtractResourceID(),
						Namespace:    mg.GetNamespace(),
						Reference:    mg.Spec.ForProvider.PathMatcher[i3].PathRule[i4].CustomErrorResponsePolicy.ErrorServiceRef,
						Selector:     mg.Spec.ForProvider.PathMatcher[i3].PathRule[i4].CustomErrorResponsePolicy.ErrorServiceSelector,
						To:           reference.To{List: l, Managed: m},
					})
				}
				if err != nil {
					return errors.Wrap(err, "mg.Spec.ForProvider.PathMatcher[i3].PathRule[i4].CustomErrorResponsePolicy.ErrorService")
				}
				mg.Spec.ForProvider.PathMatcher[i3].PathRule[i4].CustomErrorResponsePolicy.ErrorService = reference.ToPtrValue(rsp.ResolvedValue)
				mg.Spec.ForProvider.PathMatcher[i3].PathRule[i4].CustomErrorResponsePolicy.ErrorServiceRef = rsp.ResolvedReference
	...
	if mg.Spec.InitProvider.DefaultCustomErrorResponsePolicy != nil {
		{
			m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "BackendBucket", "BackendBucketList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			...
			rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
				CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.DefaultCustomErrorResponsePolicy.ErrorService),
				Extract:      resource.ExtractResourceID(),
				Namespace:    mg.GetNamespace(),
				Reference:    mg.Spec.InitProvider.DefaultCustomErrorResponsePolicy.ErrorServiceRef,
				Selector:     mg.Spec.InitProvider.DefaultCustomErrorResponsePolicy.ErrorServiceSelector,
				To:           reference.To{List: l, Managed: m},
			})
		}
		if err != nil {
			return errors.Wrap(err, "mg.Spec.InitProvider.DefaultCustomErrorResponsePolicy.ErrorService")
		}
		mg.Spec.InitProvider.DefaultCustomErrorResponsePolicy.ErrorService = reference.ToPtrValue(rsp.ResolvedValue)
		mg.Spec.InitProvider.DefaultCustomErrorResponsePolicy.ErrorServiceRef = rsp.ResolvedReference
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.PathMatcher); i3++ {
		if mg.Spec.InitProvider.PathMatcher[i3].DefaultCustomErrorResponsePolicy != nil {
			{
				m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "BackendBucket", "BackendBucketList")
				if err != nil {
					return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
				...
				rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
					CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.PathMatcher[i3].DefaultCustomErrorResponsePolicy.ErrorService),
					Extract:      resource.ExtractResourceID(),
					Namespace:    mg.GetNamespace(),
					Reference:    mg.Spec.InitProvider.PathMatcher[i3].DefaultCustomErrorResponsePolicy.ErrorServiceRef,
					Selector:     mg.Spec.InitProvider.PathMatcher[i3].DefaultCustomErrorResponsePolicy.ErrorServiceSelector,
					To:           reference.To{List: l, Managed: m},
				})
			}
			if err != nil {
				return errors.Wrap(err, "mg.Spec.InitProvider.PathMatcher[i3].DefaultCustomErrorResponsePolicy.ErrorService")
			}
			mg.Spec.InitProvider.PathMatcher[i3].DefaultCustomErrorResponsePolicy.ErrorService = reference.ToPtrValue(rsp.ResolvedValue)
			mg.Spec.InitProvider.PathMatcher[i3].DefaultCustomErrorResponsePolicy.ErrorServiceRef = rsp.ResolvedReference
	...
	for i3 := 0; i3 < len(mg.Spec.InitProvider.PathMatcher); i3++ {
		for i4 := 0; i4 < len(mg.Spec.InitProvider.PathMatcher[i3].PathRule); i4++ {
			if mg.Spec.InitProvider.PathMatcher[i3].PathRule[i4].CustomErrorResponsePolicy != nil {
				{
					m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "BackendBucket", "BackendBucketList")
					if err != nil {
						return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
					...
					rsp, err = r.Resolve(ctx, reference.NamespacedResolutionRequest{
						CurrentValue: reference.FromPtrValue(mg.Spec.InitProvider.PathMatcher[i3].PathRule[i4].CustomErrorResponsePolicy.ErrorService),
						Extract:      resource.ExtractResourceID(),
						Namespace:    mg.GetNamespace(),
						Reference:    mg.Spec.InitProvider.PathMatcher[i3].PathRule[i4].CustomErrorResponsePolicy.ErrorServiceRef,
						Selector:     mg.Spec.InitProvider.PathMatcher[i3].PathRule[i4].CustomErrorResponsePolicy.ErrorServiceSelector,
						To:           reference.To{List: l, Managed: m},
					})
				}
				if err != nil {
					return errors.Wrap(err, "mg.Spec.InitProvider.PathMatcher[i3].PathRule[i4].CustomErrorResponsePolicy.ErrorService")
				}
				mg.Spec.InitProvider.PathMatcher[i3].PathRule[i4].CustomErrorResponsePolicy.ErrorService = reference.ToPtrValue(rsp.ResolvedValue)
				mg.Spec.InitProvider.PathMatcher[i3].PathRule[i4].CustomErrorResponsePolicy.ErrorServiceRef = rsp.ResolvedReference
...
func (mg *VPNTunnel) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "ExternalVPNGateway", "ExternalVPNGatewayList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	mg.Spec.ForProvider.RouterRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "VPNGateway", "VPNGatewayList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
	...
	{
		m, l, err = apisresolver.GetManagedResource("compute.gcp.m.upbound.io", "v1beta1", "HaVPNGateway", "HaVPNGatewayList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
