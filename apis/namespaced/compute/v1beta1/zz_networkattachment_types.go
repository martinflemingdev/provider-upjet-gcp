...
type NetworkAttachmentInitParameters struct {
	...
	// References to Project in cloudplatform to populate producerAcceptLists.
	// +kubebuilder:validation:Optional
	ProducerAcceptListsRefs []v1.NamespacedReference `json:"producerAcceptListsRefs,omitempty" tf:"-"`

	// Selector for a list of Project in cloudplatform to populate producerAcceptLists.
	// +kubebuilder:validation:Optional
	ProducerAcceptListsSelector *v1.NamespacedSelector `json:"producerAcceptListsSelector,omitempty" tf:"-"`
	...
	// References to Project in cloudplatform to populate producerRejectLists.
	// +kubebuilder:validation:Optional
	ProducerRejectListsRefs []v1.NamespacedReference `json:"producerRejectListsRefs,omitempty" tf:"-"`

	// Selector for a list of Project in cloudplatform to populate producerRejectLists.
	// +kubebuilder:validation:Optional
	ProducerRejectListsSelector *v1.NamespacedSelector `json:"producerRejectListsSelector,omitempty" tf:"-"`
