...
func (tr *ConnectionProfile) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"forward_ssh_connectivity[*].password": "forwardSshConnectivity.passwordSecretRef", "forward_ssh_connectivity[*].private_key": "forwardSshConnectivity.privateKeySecretRef", "mongodb_profile[*].password": "mongodbProfile.passwordSecretRef", "mongodb_profile[*].ssl_config[*].ca_certificate": "mongodbProfile.sslConfig.caCertificateSecretRef", "mongodb_profile[*].ssl_config[*].client_certificate": "mongodbProfile.sslConfig.clientCertificateSecretRef", "mongodb_profile[*].ssl_config[*].client_key": "mongodbProfile.sslConfig.clientKeySecretRef", "mongodb_profile[*].ssl_config[*].secret_manager_stored_client_key": "mongodbProfile.sslConfig.secretManagerStoredClientKeySecretRef", "mysql_profile[*].password": "mysqlProfile.passwordSecretRef", "mysql_profile[*].ssl_config[*].ca_certificate": "mysqlProfile.sslConfig.caCertificateSecretRef", "mysql_profile[*].ssl_config[*].client_certificate": "mysqlProfile.sslConfig.clientCertificateSecretRef", "mysql_profile[*].ssl_config[*].client_key": "mysqlProfile.sslConfig.clientKeySecretRef", "oracle_profile[*].password": "oracleProfile.passwordSecretRef", "postgresql_profile[*].password": "postgresqlProfile.passwordSecretRef", "sql_server_profile[*].password": "sqlServerProfile.passwordSecretRef"}
}
