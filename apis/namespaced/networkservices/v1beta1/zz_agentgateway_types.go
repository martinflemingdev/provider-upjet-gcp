...
type AgentGatewayInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/v3/apis/namespaced/networkservices/v1beta1.AgentConnectivityTemplate
	...
	AgentConnectivityTemplateRef *v2.NamespacedReference `json:"agentConnectivityTemplateRef,omitempty" tf:"-"`

	// Selector for a AgentConnectivityTemplate in networkservices to populate agentConnectivityTemplate.
	// +kubebuilder:validation:Optional
	AgentConnectivityTemplateSelector *v2.NamespacedSelector `json:"agentConnectivityTemplateSelector,omitempty" tf:"-"`
