...
type DNSPeeringConfigsInitParameters struct {
	...
	TargetNetworkRef *v1.NamespacedReference `json:"targetNetworkRef,omitempty" tf:"-"`

	// Selector for a Network in compute to populate targetNetwork.
	// +kubebuilder:validation:Optional
	TargetNetworkSelector *v1.NamespacedSelector `json:"targetNetworkSelector,omitempty" tf:"-"`
...
type DeploymentSpecEnvInitParameters struct {
...
type DeploymentSpecEnvObservation struct {
...
type DeploymentSpecEnvParameters struct {
...
type DeploymentSpecInitParameters struct {
	...
	Env []DeploymentSpecEnvInitParameters `json:"env,omitempty" tf:"env,omitempty"`
...
type DeploymentSpecObservation struct {
	...
	// Engine deployment.
	// Structure is documented below.
	Env []DeploymentSpecEnvObservation `json:"env,omitempty" tf:"env,omitempty"`
...
type DeploymentSpecParameters struct {
	...
	// Structure is documented below.
	// +kubebuilder:validation:Optional
	Env []DeploymentSpecEnvParameters `json:"env,omitempty" tf:"env,omitempty"`
...
type DeveloperConnectSourceConfigInitParameters struct {
...
type DeveloperConnectSourceConfigObservation struct {
...
type DeveloperConnectSourceConfigParameters struct {
...
type DeveloperConnectSourceInitParameters struct {
	...
	// Structure is documented below.
	Config *DeveloperConnectSourceConfigInitParameters `json:"config,omitempty" tf:"config,omitempty"`
}
...
type DeveloperConnectSourceObservation struct {
	...
	// The Developer Connect configuration that defines the specific repository, revision, and directory to use as the source code root.
	// Structure is documented below.
	Config *DeveloperConnectSourceConfigObservation `json:"config,omitempty" tf:"config,omitempty"`
}
...
type PscInterfaceConfigInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/v2/apis/namespaced/compute/v1beta1.NetworkAttachment
	...
	// +kubebuilder:validation:Optional
	NetworkAttachmentRef *v1.NamespacedReference `json:"networkAttachmentRef,omitempty" tf:"-"`

	// Selector for a NetworkAttachment in compute to populate networkAttachment.
	// +kubebuilder:validation:Optional
	NetworkAttachmentSelector *v1.NamespacedSelector `json:"networkAttachmentSelector,omitempty" tf:"-"`
}
...
type ReasoningEngineEncryptionSpecInitParameters struct {
...
type ReasoningEngineEncryptionSpecObservation struct {
...
type ReasoningEngineEncryptionSpecParameters struct {
...
type ReasoningEngineObservation struct {
	...
	// will be secured by this key.
	// Structure is documented below.
	EncryptionSpec *ReasoningEngineEncryptionSpecObservation `json:"encryptionSpec,omitempty" tf:"encryption_spec,omitempty"`
