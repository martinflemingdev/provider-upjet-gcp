...
type AccessConfigsInitParameters struct {
	...
	// +kubebuilder:validation:Optional
	ExternalIPRef *v1.NamespacedReference `json:"externalIpRef,omitempty" tf:"-"`

	// Selector for a Address in compute to populate externalIp.
	// +kubebuilder:validation:Optional
	ExternalIPSelector *v1.NamespacedSelector `json:"externalIpSelector,omitempty" tf:"-"`
}
...
type InstanceInitParameters struct {
	...
	EnableManagedEuc *bool `json:"enableManagedEuc,omitempty" tf:"enable_managed_euc,omitempty"`
...
type ReservationAffinityInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/v2/apis/namespaced/compute/v1beta1.Reservation
	Values []*string `json:"values,omitempty" tf:"values,omitempty"`

	// References to Reservation in compute to populate values.
	// +kubebuilder:validation:Optional
	ValuesRefs []v1.NamespacedReference `json:"valuesRefs,omitempty" tf:"-"`

	// Selector for a list of Reservation in compute to populate values.
	// +kubebuilder:validation:Optional
