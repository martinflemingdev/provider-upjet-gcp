...
type Workflow struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.sourceContents) || (has(self.initProvider) && has(self.initProvider.sourceContents))",message="spec.forProvider.sourceContents is a required parameter"
