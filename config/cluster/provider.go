...
import (
	"github.com/upbound/provider-gcp/v3/config/cluster/accessapproval"
	...
	composer "github.com/upbound/provider-gcp/v3/config/cluster/cloudcomposer"
	"github.com/upbound/provider-gcp/v3/config/cluster/cloudfunctions"
	"github.com/upbound/provider-gcp/v3/config/cluster/cloudplatform"
	"github.com/upbound/provider-gcp/v3/config/cluster/cloudrun"
	"github.com/upbound/provider-gcp/v3/config/cluster/cloudscheduler"
	"github.com/upbound/provider-gcp/v3/config/cluster/cloudtasks"
	"github.com/upbound/provider-gcp/v3/config/cluster/compute"
	"github.com/upbound/provider-gcp/v3/config/cluster/container"
	"github.com/upbound/provider-gcp/v3/config/cluster/containerattached"
	"github.com/upbound/provider-gcp/v3/config/cluster/containeraws"
	"github.com/upbound/provider-gcp/v3/config/cluster/containerazure"
	"github.com/upbound/provider-gcp/v3/config/cluster/dataform"
	"github.com/upbound/provider-gcp/v3/config/cluster/dataflow"
	"github.com/upbound/provider-gcp/v3/config/cluster/dataplex"
	"github.com/upbound/provider-gcp/v3/config/cluster/dataproc"
	"github.com/upbound/provider-gcp/v3/config/cluster/datastream"
	"github.com/upbound/provider-gcp/v3/config/cluster/developerconnect"
	"github.com/upbound/provider-gcp/v3/config/cluster/dns"
	"github.com/upbound/provider-gcp/v3/config/cluster/endpoints"
	"github.com/upbound/provider-gcp/v3/config/cluster/firebaserules"
	"github.com/upbound/provider-gcp/v3/config/cluster/gameservices"
	"github.com/upbound/provider-gcp/v3/config/cluster/gkehub"
	"github.com/upbound/provider-gcp/v3/config/cluster/healthcare"
	"github.com/upbound/provider-gcp/v3/config/cluster/iap"
	"github.com/upbound/provider-gcp/v3/config/cluster/identityplatform"
	"github.com/upbound/provider-gcp/v3/config/cluster/kms"
	"github.com/upbound/provider-gcp/v3/config/cluster/logging"
	...
	"github.com/upbound/provider-gcp/v3/config/cluster/project"
	"github.com/upbound/provider-gcp/v3/config/cluster/pubsub"
	"github.com/upbound/provider-gcp/v3/config/cluster/redis"
	"github.com/upbound/provider-gcp/v3/config/cluster/secretmanager"
	"github.com/upbound/provider-gcp/v3/config/cluster/servicenetworking"
	"github.com/upbound/provider-gcp/v3/config/cluster/sourcerepo"
	"github.com/upbound/provider-gcp/v3/config/cluster/spanner"
	"github.com/upbound/provider-gcp/v3/config/cluster/sql"
	"github.com/upbound/provider-gcp/v3/config/cluster/storage"
	"github.com/upbound/provider-gcp/v3/config/cluster/storagetransfer"
	"github.com/upbound/provider-gcp/v3/config/cluster/tags"
	"github.com/upbound/provider-gcp/v3/config/cluster/vertexai"
	"github.com/upbound/provider-gcp/v3/config/cluster/vpcaccess"
)
