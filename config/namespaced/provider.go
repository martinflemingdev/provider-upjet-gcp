...
import (
	"github.com/upbound/provider-gcp/v3/config/namespaced/accessapproval"
	...
	composer "github.com/upbound/provider-gcp/v3/config/namespaced/cloudcomposer"
	"github.com/upbound/provider-gcp/v3/config/namespaced/cloudfunctions"
	"github.com/upbound/provider-gcp/v3/config/namespaced/cloudplatform"
	"github.com/upbound/provider-gcp/v3/config/namespaced/cloudrun"
	"github.com/upbound/provider-gcp/v3/config/namespaced/cloudscheduler"
	"github.com/upbound/provider-gcp/v3/config/namespaced/cloudtasks"
	"github.com/upbound/provider-gcp/v3/config/namespaced/compute"
	"github.com/upbound/provider-gcp/v3/config/namespaced/container"
	"github.com/upbound/provider-gcp/v3/config/namespaced/containerattached"
	"github.com/upbound/provider-gcp/v3/config/namespaced/containeraws"
	"github.com/upbound/provider-gcp/v3/config/namespaced/containerazure"
	"github.com/upbound/provider-gcp/v3/config/namespaced/dataform"
	"github.com/upbound/provider-gcp/v3/config/namespaced/dataflow"
	"github.com/upbound/provider-gcp/v3/config/namespaced/dataplex"
	"github.com/upbound/provider-gcp/v3/config/namespaced/dataproc"
	"github.com/upbound/provider-gcp/v3/config/namespaced/datastream"
	"github.com/upbound/provider-gcp/v3/config/namespaced/developerconnect"
	"github.com/upbound/provider-gcp/v3/config/namespaced/dns"
	"github.com/upbound/provider-gcp/v3/config/namespaced/endpoints"
	"github.com/upbound/provider-gcp/v3/config/namespaced/firebaserules"
	"github.com/upbound/provider-gcp/v3/config/namespaced/gameservices"
	"github.com/upbound/provider-gcp/v3/config/namespaced/gkehub"
	"github.com/upbound/provider-gcp/v3/config/namespaced/healthcare"
	"github.com/upbound/provider-gcp/v3/config/namespaced/iap"
	"github.com/upbound/provider-gcp/v3/config/namespaced/identityplatform"
	"github.com/upbound/provider-gcp/v3/config/namespaced/kms"
	"github.com/upbound/provider-gcp/v3/config/namespaced/logging"
	"github.com/upbound/provider-gcp/v3/config/namespaced/modelarmor"
	"github.com/upbound/provider-gcp/v3/config/namespaced/monitoring"
	"github.com/upbound/provider-gcp/v3/config/namespaced/networksecurity"
	"github.com/upbound/provider-gcp/v3/config/namespaced/networkservices"
	"github.com/upbound/provider-gcp/v3/config/namespaced/notebooks"
	"github.com/upbound/provider-gcp/v3/config/namespaced/oslogin"
	"github.com/upbound/provider-gcp/v3/config/namespaced/privateca"
	"github.com/upbound/provider-gcp/v3/config/namespaced/project"
	"github.com/upbound/provider-gcp/v3/config/namespaced/pubsub"
	"github.com/upbound/provider-gcp/v3/config/namespaced/redis"
	"github.com/upbound/provider-gcp/v3/config/namespaced/secretmanager"
	"github.com/upbound/provider-gcp/v3/config/namespaced/servicenetworking"
	"github.com/upbound/provider-gcp/v3/config/namespaced/sourcerepo"
	"github.com/upbound/provider-gcp/v3/config/namespaced/spanner"
	"github.com/upbound/provider-gcp/v3/config/namespaced/sql"
	"github.com/upbound/provider-gcp/v3/config/namespaced/storage"
	"github.com/upbound/provider-gcp/v3/config/namespaced/storagetransfer"
	"github.com/upbound/provider-gcp/v3/config/namespaced/tags"
	"github.com/upbound/provider-gcp/v3/config/namespaced/vertexai"
	"github.com/upbound/provider-gcp/v3/config/namespaced/vpcaccess"
)
...
func init() {
	...
	ProviderConfiguration.AddConfig(dataform.Configure)
