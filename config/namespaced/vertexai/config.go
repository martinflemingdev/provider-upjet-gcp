...
func Configure(p *config.Provider) {
	...
	p.AddResourceConfigurator("google_vertex_ai_featurestore_entitytype_feature", func(r *config.Resource) {
		r.References["entitytype"] = config.Reference{
			TerraformName: "google_vertex_ai_featurestore_entitytype",
		}
		config.MarkAsRequired(r.TerraformResource, "entitytype")
		config.MarkAsRequired(r.TerraformResource, "value_type")
	})
