...
|----------|----------------|-------------------------|------------------------|-------|
| `google_vertex_ai_deployment_resource_pool` | ✅ | ✅ (not present) | ⬜ | TemplatedStringAsIdentifier |
| `google_vertex_ai_endpoint` | ✅ | ✅ (commented out) | ⬜ | TemplatedStringAsIdentifier |
| `google_vertex_ai_endpoint_iam_member` | ✅ | ✅ (not present) | ⬜ | IdentifierFromProvider (IAM) |
| `google_vertex_ai_endpoint_with_model_garden_deployment` | ✅ | ✅ (not present) | ⬜ | IdentifierFromProvider (No Import) |
| `google_vertex_ai_index` | ✅ | ✅ (commented out) | ⬜ | TemplatedStringAsIdentifier |
| `google_vertex_ai_index_endpoint` | ✅ | ✅ (not present) | ⬜ | TemplatedStringAsIdentifier |
| `google_vertex_ai_index_endpoint_deployed_index` | ✅ | ✅ (not present) | ⬜ | TemplatedStringAsIdentifier |
| `google_vertex_ai_metadata_store` | ✅ | ✅ (not present) | ⬜ | TemplatedStringAsIdentifier |
| `google_vertex_ai_rag_engine_config` | ✅ | ✅ (not present) | ⬜ | TemplatedStringAsIdentifier (region singleton) |
